...
class ArcgisAPI(object):
    ...
    def __init__(self, access_token=None, refresh_token=None, client_id=None, username=None, base_url=ARCGIS_BASE_URL):
        ...
        # register APIs
        self.services = ServicesAPI(base_url=base_url, requester=self.requester, username=username)
